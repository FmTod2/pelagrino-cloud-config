# Tmux Preset Configuration

This NixOS module configures Tmux with various settings and plugins. It includes options to enable Tmux and integrate it with Zsh.
...
- **Type:** `boolean`
- **Default:** `false`
- **Description:** Enable Tmux integration with Zsh.
...
- **Enable Tmux integration with Zsh:**

  ```nix
  programs.zsh.initExtra = mkIf cfg.zshIntegration ''
